#[cfg(test)] mod tests {  
    ...
    fn claim_airdrop() {
        // Import our keypair 
        let keypair = read_keypair_file("/root/prereq2/dev-wallet.json").expect("Couldn't find wallet file");
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("9kVoR3eBvy2D7marMPcyZkUv15zLZrKhxkvJcr9ddMmq").unwrap(); 
    ...
    fn submit_rs(){
        let rpc_client = RpcClient::new(RPC_URL); 
        let signer = read_keypair_file("/root/prereq2/wallet.json") 
